#!/usr/bin/env python3
"""
Jizzax viloyati uchun o'quv markazlarini yig'ish scripti
"""
...
REGION_KEY = "jizzax_viloyat"
REGION_NAME = "Jizzax viloyati"
CITIES = [{'name': 'Jizzax', 'lat': 40.1158, 'lng': 67.8422}, {'name': "G'allaorol", 'lat': 40.2833, 'lng': 67.6833}, {'name': 'Paxtakor', 'lat': 40.2333, 'lng': 68.0167}, {'name': 'Zarbdor', 'lat': 40.8833, 'lng': 71.6667}, {'name': 'Mingbuloq', 'lat': 40.9333, 'lng': 68.1167}, {'name': 'Forish', 'lat': 40.1167, 'lng': 67.5167}, {'name': 'Yangibozor', 'lat': 40.35, 'lng': 67.45}]
