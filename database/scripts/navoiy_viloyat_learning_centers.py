#!/usr/bin/env python3
"""
Navoiy viloyati uchun o'quv markazlarini yig'ish scripti
"""
...
REGION_KEY = "navoiy_viloyat"
REGION_NAME = "Navoiy viloyati"
CITIES = [{'name': 'Navoiy', 'lat': 40.1008, 'lng': 65.3792}, {'name': 'Zarafshon', 'lat': 40.1333, 'lng': 67.6167}, {'name': 'Uchquduq', 'lat': 40.1167, 'lng': 66.9167}, {'name': 'Tomdibuloq', 'lat': 40.0667, 'lng': 66.8167}, {'name': 'Qiziltepa', 'lat': 40.45, 'lng': 65.65}, {'name': 'Nurota', 'lat': 40.1167, 'lng': 65.6833}, {'name': 'Konimex', 'lat': 39.75, 'lng': 65.2833}]
