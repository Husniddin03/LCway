#!/usr/bin/env python3
"""
Qashqadaryo viloyati uchun o'quv markazlarini yig'ish scripti
"""
...
REGION_KEY = "qashqadaryo_viloyat"
REGION_NAME = "Qashqadaryo viloyati"
CITIES = [{'name': 'Qarshi', 'lat': 38.861, 'lng': 65.7883}, {'name': 'Qamashi', 'lat': 39.9667, 'lng': 66.8833}, {'name': 'Muborak', 'lat': 39.5667, 'lng': 65.6833}, {'name': 'Koson', 'lat': 39.55, 'lng': 65.5833}, {'name': "Yakkabog'", 'lat': 39.6167, 'lng': 66.3167}, {'name': 'Qiziltepa', 'lat': 38.9167, 'lng': 65.7833}, {'name': 'Shahrisabz', 'lat': 39.3, 'lng': 66.4167}, {'name': 'Kitob', 'lat': 39.6667, 'lng': 66.8667}, {'name': 'Mirzachul', 'lat': 40.75, 'lng': 68.8333}]
