#!/usr/bin/env python3
"""
{region_name} uchun o'quv markazlarini yig'ish scripti
"""
...
def collect_region_learning_centers():
    ...
    for i, city in enumerate(CITIES, 1):
        ...
        for j, keyword in enumerate(EFFICIENT_KEYWORDS, 1):
            ...
            token = None
            page_count = 0
            max_pages = 2  # Har bir kalit so'z uchun maksimum 2 sahifa
...
def main():
    ...
    # 3. JSON ga yozish
    outfile = os.path.join(OUTPUT_DIR, "{{REGION_KEY}}_learning_centers.json")
    payload = {{
