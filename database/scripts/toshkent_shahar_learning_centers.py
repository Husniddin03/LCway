#!/usr/bin/env python3
"""
Toshkent shahar uchun o'quv markazlarini yig'ish scripti
"""
...
REGION_KEY = "toshkent_shahar"
REGION_NAME = "Toshkent shahar"
CITIES = [{'name': 'Toshkent', 'lat': 41.2995, 'lng': 69.2401}, {'name': 'Chirchiq', 'lat': 41.5333, 'lng': 69.5833}, {'name': 'Angren', 'lat': 41.0167, 'lng': 70.1333}]
