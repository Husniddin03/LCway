...
<div x-show="modals.image" class="fixed inset-0 z-50 flex items-center justify-center" style="display: none;" x-cloak>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-4xl mx-4 relative z-10 max-h-[90vh] overflow-y-auto">
        ...
        <div class="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 sticky top-0 bg-white dark:bg-gray-800 z-20">
            <h3 class="font-semibold text-gray-900 dark:text-white">Rasmlar boshqaruvi</h3>
        ...
        <div class="p-6 space-y-6">
            ...
            <div x-show="images.length > 0">
                <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Mavjud rasmlar</h4>
            ...
            <div x-show="images.length === 0" class="text-center py-8 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                ...
                <p class="text-gray-500 dark:text-gray-400">Rasmlar yo'q</p>
            </div>

            {{-- Upload Section --}}
            <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Yangi rasm yuklash</h4>
                ...
                <div x-ref="dropZone"
                    ...
                    <p class="text-gray-700 dark:text-gray-300 font-medium mb-1">Rasmlarni bu yerga tashlang yoki bosing</p>
                    <p class="text-sm text-gray-500 dark:text-gray-400">JPG, PNG, GIF, WebP (max 2MB)</p>
                </div>

                {{-- Preview Selected Images --}}
                <div x-show="imageUploads.previews.length > 0" class="mt-4">
                    <div class="flex items-center justify-between mb-3">
                        <h5 class="text-sm font-medium text-gray-700 dark:text-gray-300">Tanlangan rasmlar (<span x-text="imageUploads.previews.length"></span>)</h5>
                    ...
                    <button @click="uploadImages()" 
                        ...
                        <span x-text="imageUploads.uploading ? 'Yuklanmoqda...' : 'Yuklash'"></span>
                    </button>
                </div>
            </div>
        </div>
