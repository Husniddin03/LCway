...
<div x-show="modals.teacher" class="fixed inset-0 z-50 flex items-center justify-center" style="display: none;">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-lg mx-4 relative z-10 max-h-[90vh] overflow-y-auto">
        <div class="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
            <h3 class="font-semibold text-gray-900 dark:text-white" x-text="editing.teacher ? 'O\'qituvchini tahrirlash' : 'Yangi o\'qituvchi'"></h3>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <label for="teacher-image-input" class="inline-flex items-center gap-2 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer text-sm">
                            ...
                            <span x-text="teacherImagePreview || forms.teacher.photo ? 'Rasmni almashtirish' : 'Rasm tanlash'"></span>
                        </label>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">JPG, PNG, GIF (max 2MB)</p>
                    </div>
                </div>
            </div>
            <div class="flex gap-3 pt-2">
                <button type="button" @click="closeTeacherModal()" class="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">Bekor</button>
