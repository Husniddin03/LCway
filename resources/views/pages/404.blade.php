    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-600 via-accent-600 to-primary-800 relative overflow-hidden">
        ...
        <div class="relative z-10 text-center px-6 max-w-2xl mx-auto">
            <div class="animate-fade-in">
                ...
                <!-- Error Illustration -->
                <div class="mb-8">
                    <div class="inline-flex items-center justify-center w-32 h-32 bg-white/10 rounded-3xl backdrop-blur-xl border border-white/20">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <x-button variant="secondary" size="lg" href="{{ route('index') }}" class="bg-white text-primary-600 hover:bg-gray-50">
                    ...
                    <x-button variant="outline" size="lg" href="#" class="border-white text-white hover:bg-white hover:text-primary-600">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
