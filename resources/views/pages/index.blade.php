<x-layout>
    ...
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden">
        <!-- Background Gradient -->
        <div class="absolute inset-0 bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 dark:from-primary-600 dark:via-accent-600 dark:to-primary-800"></div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 text-center">
            <div class="animate-fade-in">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                    <x-button variant="secondary" size="lg" href="{{ route('blog-grid') }}" class="bg-white text-primary-600 hover:bg-gray-50 dark:hover:bg-gray-100">
                    ...
                    <x-button variant="outline" size="lg" class="border-gray-300 text-gray-700 hover:bg-gray-50 hover:text-primary-600 dark:border-white dark:text-white dark:hover:bg-white dark:hover:text-primary-600">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div class="relative">
                    ...
                    <div class="absolute -bottom-4 -right-4 z-10">
                        <img src="{{ asset('images/we2.png') }}" alt="About" class="rounded-2xl shadow-xl opacity-80 w-32 h-32 object-cover">
                    </div>
                    <div class="absolute -top-4 -left-4 z-10">
                        <img src="{{ asset('images/we3.png') }}" alt="About" class="rounded-2xl shadow-xl opacity-60 w-24 h-24 object-cover">
                    </div>
                </div>
    ...
    <section class="py-16 bg-white dark:bg-gray-800">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                @if(isset($centers) && $centers->count() > 0)
                    @foreach($centers->take(8) as $center)
                        <x-card hover class="group cursor-pointer bg-white dark:from-gray-800/50 dark:to-gray-900/50 backdrop-blur-sm border border-gray-100 dark:border-gray-700/50 shadow-md hover:shadow-lg transition-all duration-300">
                            <div class="relative overflow-hidden rounded-t-2xl">
                                ...
                                <!-- Rating Badge -->
                                <div class="absolute top-4 right-4 bg-white dark:bg-gray-900/95 backdrop-blur-sm px-3 py-1.5 rounded-full shadow-md border border-gray-100 dark:border-gray-700/50">
                                    @php
            ...
            <div class="text-center mt-12">
                <x-button variant="primary" size="lg" href="{{ route('blog-grid') }}" class="dark:bg-primary-600 text-gray-900 dark:text-white dark:hover:bg-primary-700">
        ...
        <div class="max-w-7xl mx-auto px-6 text-center relative z-10">
            <div class="max-w-3xl mx-auto">
                <h2 class="text-4xl md:text-5xl font-bold text-white mb-6 text-gray-900 dark:text-white mb-4">
                    Hozirda ro'yxatdan o'tganlar o'quv markazlar soni: <span class="text-yellow-300">{{ $centers->count() ?? 0 }} ta</span>
                </h2>
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex items-start space-x-4 group">
                                <div class="w-12 h-12 bg-blue-100 dark:bg-blue-900/30 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-blue-200 dark:group-hover:bg-blue-900/50 transition-colors">
                                    <svg class="w-6 h-6 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>
                                </div>
                                <div>
                                    <h4 class="font-semibold text-gray-900 dark:text-white mb-1">Elektron pochta</h4>
                                    <a href="mailto:husniddin13124041@gmail.com" class="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                            ...
                            <!-- Address -->
                            <div class="flex items-start space-x-4 group">
                                <div class="w-12 h-12 bg-green-100 dark:bg-green-900/30 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-green-200 dark:group-hover:bg-green-900/50 transition-colors">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 dark:text-gray-400">
                                        M254+HFP, улица Усто Умара Джуракулова, Samarqand, Samarqand viloyati, Uzbekistan
                                    </p>
                                </div>
                            </div>
                            ...
                            <!-- Phone -->
                            <div class="flex items-start space-x-4 group">
                                <div class="w-12 h-12 bg-purple-100 dark:bg-purple-900/30 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-purple-200 dark:group-hover:bg-purple-900/50 transition-colors">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+998770252677" class="text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors">
                                        +998 77 025 26 77
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div class="flex space-x-3">
                                <a href="https://t.me/matritsachi" target="_blank" class="w-12 h-12 bg-blue-500 hover:bg-blue-600 rounded-xl flex items-center justify-center text-white transition-all transform hover:scale-110 shadow-lg">
