    ...
    <x-slot:title>{{ __('index.title') }}</x-slot:title>
        ...
        <section class="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-6 text-center">
                <div class="animate-fade-in">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                        <x-button variant="secondary" size="lg" href="{{ route('blog-grid') }}"
            ...
            <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
                <svg class="w-6 h-6 text-gray-400 dark:text-white/60" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="relative overflow-hidden rounded-t-2xl">
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center space-x-1">
                                            <span
                                                class="text-amber-500 dark:text-yellow-400 text-sm font-semibold">★</span>
                                            <span
                                                class="text-sm font-semibold text-gray-800 dark:text-white">{{ $average }}</span>
                                        </div>
                                    </div>
                                </div>
