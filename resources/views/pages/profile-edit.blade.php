                ...
                <div class="border rounded-2xl border-gray-200/60 backdrop-blur-xl bg-white/90 dark:bg-gray-800/95 shadow-2xl dark:shadow-black/20 border-gray-200 dark:border-gray-700">
                    <div class="p-8">
                        ...
                        <div class="text-center mb-8">
                            ...
                            <h1 class="text-2xl font-bold mb-2 bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">Profilni tahrirlash</h1>
                        ...
                        <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                            ...
                            <div class="text-center mb-8">
                                <div class="relative inline-block">
                                    @isset(Auth::user()->avatar)
                                        <img id="avatar-preview" src="{{ Auth::user()->avatar }}" alt="{{ Auth::user()->name }}" class="w-24 h-24 rounded-full ring-4 ring-white dark:ring-gray-800 shadow-xl">
                                    @else
                                        <img id="avatar-preview" src="https://ui-avatars.com/api/?name={{ Auth::user()->name }}&background=random&size=96" alt="{{ Auth::user()->name }}" class="w-24 h-24 rounded-full ring-4 ring-white dark:ring-gray-800 shadow-xl">
                                    @endisset
                                    <label for="avatar" class="absolute bottom-0 right-0 w-8 h-8 bg-primary-600 rounded-full flex items-center justify-center cursor-pointer hover:bg-primary-700 transition-colors duration-200">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-2">Rasmni o'zgartirish uchun kameraga bosing</p>
                            </div>
                            ...
                            <!-- Password Fields -->
                            <div class="border-t pt-6">
                                <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Parolni o'zgartirish</h3>
                            ...
                            <div class="flex space-x-4 pt-6">
                                <button type="submit" class="flex-1 px-6 py-3 bg-gradient-to-r from-primary-600 to-accent-600 text-white rounded-lg hover:shadow-lg transition-all duration-300 font-medium">
                                    Saqlash
                                </button>
                                <a href="{{ route('profile') }}" class="flex-1 px-6 py-3 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-all duration-200 font-medium text-center">
                                    Bekor qilish
                                </a>
                            </div>
                        </form>
