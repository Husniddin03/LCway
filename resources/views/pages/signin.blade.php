            ...
            <div class="border rounded-2xl border-gray-200/60 backdrop-blur-xl bg-white/90 dark:bg-gray-800/95 shadow-2xl dark:shadow-black/20 border-gray-200 dark:border-gray-700">
                <div class="p-8">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <h2 class="text-2xl font-bold mb-2 bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">Hisobingizga kirish</h2>
                    ...
                    <form action="{{ route('login') }}" method="POST" class="space-y-4">
                        ...
                        <div class="flex items-center justify-between">
                            <label class="flex items-center">
                                <input type="checkbox" name="remember" class="rounded transition-colors duration-200 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-blue-600 focus:ring-2 focus:ring-blue-500/20 dark:focus:ring-blue-400/20 focus:ring-offset-2 dark:focus:ring-offset-0 hover:border-blue-400 dark:hover:border-blue-500">
                                <span class="ml-2 text-sm text-gray-600 dark:text-gray-400">Eslab qolish</span>
                            </label>
                            
                            <a href="#" class="text-sm transition-colors text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium hover:underline">
                    ...
                    <div class="mt-6 text-center">
                        <p class="text-gray-600 dark:text-gray-400">
                            Hisobingiz yo'qmi? 
                            <a href="{{ route('signup') }}" class="font-medium transition-colors text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 hover:underline">
                                Ro'yxatdan o'ting
                            </a>
                        </p>
                    </div>
