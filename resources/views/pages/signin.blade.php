            ...
            <x-card class="glass-dark border border-white/20 backdrop-blur-xl">
                <div class="p-8">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <h2 class="text-2xl font-bold text-white mb-2">Hisobingizga kirish</h2>
                        <p class="text-white/80">FindCourse platformasiga xush kelibsiz</p>
                    </div>
                    ...
                    <form action="{{ route('login') }}" method="POST" class="space-y-4">
                        ...
                        <div class="flex items-center justify-between">
                            <label class="flex items-center">
                                <input type="checkbox" name="remember" class="rounded border-white/20 bg-white/10 text-primary-600 focus:ring-primary-500 focus:ring-offset-0">
                                <span class="ml-2 text-sm text-white/80">Eslab qolish</span>
                            </label>
                    ...
                    <div class="mt-6 text-center">
                        <p class="text-white/80">
                            Hisobingiz yo'qmi? 
                            <a href="{{ route('signup') }}" class="text-white font-medium hover:text-white/90 transition-colors">
                                Ro'yxatdan o'ting
                            </a>
                        </p>
                    </div>
