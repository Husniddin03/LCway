            ...
            <div class="border border-white/20 backdrop-blur-xl bg-white/95 dark:bg-gray-900/95 border-gray-200 dark:border-white/20">
                <div class="p-8">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <h2 class="text-2xl font-bold mb-2 text-gray-900 dark:text-white">Ro'yxatdan o'tish</h2>
                        <p class="mb-2 text-gray-600 dark:text-white/80">FindCourse platformasiga qo'shiling</p>
                    </div>
                    ...
                    <form action="{{ route('register') }}" method="POST" class="space-y-4">
                        ...
                        <!-- Full Name Field -->
                        <div>
                            <label for="name" class="block text-sm font-medium mb-2 text-gray-700 dark:text-white/90">
                                To'liq ism
                            </label>
                            <input 
                                type="text" 
                        ...
                        <div class="flex items-start">
                            <input type="checkbox" name="terms" class="mt-1 rounded transition-colors duration-200 border-gray-300 dark:border-white/20 bg-white dark:bg-white/10 text-primary-600 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-0" required>>
                            <label for="terms" class="ml-2 text-sm text-gray-600 dark:text-white/80">
                                Men <a href="#" class="transition-colors text-primary-600 hover:text-primary-700 dark:text-white dark:hover:text-white/90">Foydalanish shartlari</a> va 
                                <a href="#" class="transition-colors text-primary-600 hover:text-primary-700 dark:text-white dark:hover:text-white/90">Maxfiylik siyosati</a> bilan tanishdim
                            </label>
                        </div>
                    ...
                    <div class="mt-6 text-center">
                        <p class="text-gray-600 dark:text-white/80">
                            Hisobingiz bormi? 
                            <a href="{{ route('signin') }}" class="font-medium transition-colors text-primary-600 hover:text-primary-700 dark:text-white dark:hover:text-white/90">
                                Kirish
                            </a>
                        </p>
                    </div>
