<x-layout>
    ...
    <div class="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-purple-900/20">
        <!-- Background Shapes -->
            ...
            <div class="border rounded-2xl border-gray-200/60 backdrop-blur-xl bg-white/90 dark:bg-gray-800/95 shadow-2xl dark:shadow-black/20 border-gray-200 dark:border-gray-700">
                <div class="p-8">
                    ...
                    <div class="text-center mb-8">
                        <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-100 via-blue-50 to-indigo-100 dark:from-gray-700 dark:to-gray-600 rounded-full mb-4 shadow-lg border border-blue-200/50 dark:border-gray-600">
                            <img src="{{ asset('images/lcwayfavicon.png') }}" alt="FindCourse" class="w-16 h-16 rounded-full">
                        </div>
                        <h2 class="text-2xl font-bold mb-2 bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">Ro'yxatdan o'tish</h2>
                    ...
                    <div class="relative mb-6">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="px-4 bg-white/80 dark:bg-transparent text-gray-500 dark:text-gray-400 font-medium">Yoki email bilan</span>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('register') }}" method="POST" class="space-y-4">
                        ...
                        <!-- Error Messages -->
                        @error('name')
                            <div class="px-4 py-3 rounded-xl text-sm bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/50 text-red-700 dark:text-red-300">
                                {{ $message }}
                            </div>
                        @enderror
                        ...
                        <div class="flex items-start">
                            <input type="checkbox" name="terms" class="mt-1 rounded transition-colors duration-200 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-blue-600 focus:ring-2 focus:ring-blue-500/20 dark:focus:ring-blue-400/20 focus:ring-offset-2 dark:focus:ring-offset-0 hover:border-blue-400 dark:hover:border-blue-500" required>
                            <label for="terms" class="ml-2 text-sm text-gray-600 dark:text-gray-400">
                                Men <a href="#" class="transition-colors text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium hover:underline">Foydalanish shartlari</a> va 
                                <a href="#" class="transition-colors text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium hover:underline">Maxfiylik siyosati</a> bilan tanishdim
                            </label>
                        </div>
                        
                        <!-- Submit Button -->
                        <button type="submit" 
                                class="w-full py-3 px-4 rounded-xl font-semibold transition-all duration-300 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-offset-2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white shadow-lg hover:shadow-xl focus:ring-blue-500/50 dark:focus:ring-offset-gray-800 dark:from-blue-500 dark:to-blue-600 dark:hover:from-blue-600 dark:hover:to-blue-700 hover:shadow-blue-500/25"
                    ...
                    <div class="mt-6 text-center">
                        <p class="text-gray-600 dark:text-gray-400">
                            Hisobingiz bormi? 
                            <a href="{{ route('signin') }}" class="font-medium transition-colors text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 hover:underline">
                                Kirish
                            </a>
                        </p>
                    </div>
