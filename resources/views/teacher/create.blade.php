        ...
        <div class="relative max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                ...
                <div class="lg:col-span-2 animate-slide-in-right">
                    <form action="{{ route('teacher.storeid', $LearningCenter->slug) }}" method="POST"
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label for="subject_type" class="block text-sm font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">
                                        ...
                                        {{ __('subject-create.form.subject_type_label') }} <span class="text-gray-400 font-normal">(ixtiyoriy)</span>
                                    </label>
                                    <input type="text" name="subject_type" id="subject_type" placeholder="Asosiy, Qo'shimcha..."
                                        class="w-full px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-400 dark:focus:border-blue-400 text-gray-900 dark:text-white transition-all duration-200 hover:border-blue-400 dark:hover:border-blue-500 shadow-sm">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="price" id="price" placeholder="500000"
                                        class="w-full px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-400 dark:focus:border-blue-400 text-gray-900 dark:text-white transition-all duration-200 hover:border-blue-400 dark:hover:border-blue-500 shadow-sm">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="currency" id="currency" list="existing-currencies" placeholder="so'm, USD..."
                                        class="w-full px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-400 dark:focus:border-blue-400 text-gray-900 dark:text-white transition-all duration-200 hover:border-blue-400 dark:hover:border-blue-500 shadow-sm">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="period" id="period" list="existing-periods" placeholder="oy, hafta, dars..."
                                        class="w-full px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-400 dark:focus:border-blue-400 text-gray-900 dark:text-white transition-all duration-200 hover:border-blue-400 dark:hover:border-blue-500 shadow-sm">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="subject_icon" id="subject_icon" placeholder="Icon class..."
                                        class="w-full px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-400 dark:focus:border-blue-400 text-gray-900 dark:text-white transition-all duration-200 hover:border-blue-400 dark:hover:border-blue-500 shadow-sm">
                            ...
                            <div>
                                ...
                                <textarea name="description" id="message" rows="4" placeholder="Fan tavsifi..."
