                        ...
                        <form action="{{ route('teacher.update', $teacher->id) }}" method="POST"
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            <h4 class="text-sm font-medium text-danger-800 dark:text-danger-200">
                                                Iltimos, xatolarni to'g'rilang:</h4>
                            ...
                            @isset($teacher->photo)
                                <div>
                                    ...
                                    <div
                                        class="w-32 h-32 rounded-xl overflow-hidden border-2 border-gray-200 dark:border-gray-700">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-input type="tel" name="phone" id="phone"
                                        placeholder="+998 90 123 45 67" value="{{ $teacher->phone }}" />
                                    @error('phone')
                                        <p class="mt-2 text-sm text-danger-600 dark:text-danger-400">{{ $message }}
                                        </p>
                                    @enderror
