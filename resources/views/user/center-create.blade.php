...
@section('title', __('course-create.title'))
@section('header', __('course-create.header.title'))
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
            <form action="{{ route('course.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
                    ...
                    <div class="relative mb-4 rounded-xl overflow-hidden shadow-lg border border-gray-200 dark:border-gray-700" id="map-wrapper">
                        <!-- Search Bar -->
                        ...
                        <!-- Loading Overlay -->
                        <div id="map-loading" class="absolute inset-0 bg-white/80 z-20 hidden flex items-center justify-center">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="legal_address" id="legal_address" rows="3"
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                placeholder="{{ __('user.center_create.legal_address_placeholder') }}">{{ old('legal_address') }}</textarea>
                            @error('legal_address')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-400 animate-fade-in">{{ $message }}</p>
                            @enderror
                        </div>
...
@section('scripts')
    <script>
        ...
        document.getElementById('region').addEventListener('change', function() {
            ...
            customOpt.textContent = "📝 Boshqa tuman (qo'lda yozing)";
        ...
        function initMap() {
            ...
            // Add OpenStreetMap tiles - Light mode for map
            ...
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(
                    pos => {
                        ...
                        showNotification('Joylashuv aniqlandi!', 'success');
                    },
                    () => {
                        updateCoordinates(DEFAULT_LAT, DEFAULT_LNG);
                        showNotification('Joriy joylashuvni aniqlash mumkin emas. Standart joylashuv ishlatilmoqda.', 'info');
                    },
        ...
        window.showMapLoading = function(show) {
        ...
        window.updateCoordinates = async function(lat, lng) {
