                    ...
                    <div class="p-8">
                        ...
                        <div class="text-center mb-8">
                            <div
                                ...
                                <img src="{{ asset('images/lcwayfavicon.png') }}" alt="Findora"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <select id="gander" name="gander" required
                                            ...
                                            <option value="male" {{ ($userData->gander ?? '') == 'male' ? 'selected' : '' }}>{{ __('profile-edit.personal_info.male') }}
                                            </option>
                                            <option value="female" {{ ($userData->gander ?? '') == 'female' ? 'selected' : '' }}>{{ __('profile-edit.personal_info.female') }}
                                            </option>
                                        </select>
                                        @error('gander')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
